...
export default function EditProfileScreen() {
  ...
  const [bio, setBio] = useState(archerProfile?.bio ?? '');
  ...
  const [preferredBowType, setPreferredBowType] = useState<PreferredBowType | null>(
  ...
  const handleSave = () => {
    setArcherProfile({
      ...
      preferredBowType: preferredBowType ?? undefined,
      isPublic,
    } as any);
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
      ...
      >
          ...
          <View style={styles.switchRow}>
            <View style={styles.switchInfo}>
              ...
              <Text style={styles.switchSubtitle}>
                Followers can see your sessions and stats
              </Text>
            </View>
            <Switch
              value={isPublic}
        ...
        {/* Preferred bow type */}
        <Text style={styles.sectionLabel}>Preferred Bow</Text>
        <View style={styles.group}>
          <View style={styles.twoColWrap}>
            {BOW_TYPES.map((bt) => (
              <SelectOption
                key={bt}
                label={bt}
                selected={preferredBowType === bt}
                onPress={() => setPreferredBowType(preferredBowType === bt ? null : bt)}
                style={styles.halfOption}
              />
            ))}
          </View>
